...
/// Floating glassmorphism bottom navigation for partner app.
                                ...
                                if (active)
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      boxShadow: [
                                        BoxShadow(color: const Color(0xFF0F766E).withValues(alpha: 0.4), blurRadius: 8, offset: const Offset(0, 2)),
                                      ],
                                    ),
                                  ).animate(target: active ? 1 : 0).scale(duration: 300.ms, curve: Curves.easeOutBack),
                                Icon(active ? item.activeIcon : item.icon, color: active ? Colors.white : const Color(0xFF64748B), size: 22),
                              ],
                            ),
